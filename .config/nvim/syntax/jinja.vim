" Stripped down version of jinja syntax from https://github.com/Glench/Vim-Jinja2-Syntax
" - removed version checking
" - removed syntax clearing (we want to combine syntaxes)
" - remove html syntax loading (htmljinja.vim takes care of that)
