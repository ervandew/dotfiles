...
-- patch file_browser to fix the cursor position after selecting a directory
-- (prevent what looks like trailing spaces in the prompt)
local fb_actions = require('telescope._extensions.file_browser.actions')
local fb_open_dir = fb_actions.open_dir
fb_actions.open_dir = function(prompt_bufnr, _, dir)
  fb_open_dir(prompt_bufnr, _, dir)
