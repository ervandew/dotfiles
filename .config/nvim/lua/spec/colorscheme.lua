return {{
  ...
  config = function()
    ...
    vim.api.nvim_set_hl(0, 'GitLink', { fg = gray8 })
    ...
    vim.api.nvim_set_hl(0, 'GitLogFiles', { fg = gray8 })
    vim.api.nvim_set_hl(0, 'GitLogFileDoesNotExist', { fg = gray5 })
    ...
    vim.api.nvim_set_hl(0, 'GitStatusConflictDeleted', { fg = yellow })
