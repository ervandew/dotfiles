...
# variable IPYTHONDIR.
# c.TerminalIPythonApp.ipython_dir = u'/home/ervandew/.config/ipython'
...
# 
c.TerminalInteractiveShell.separate_out = '0'
...
# c.TerminalInteractiveShell.banner1 = 'Python 2.6.8 (unknown, Jun 23 2012, 13:23:26) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.13.1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
prompt = os.environ.get('PYTHONPROMPT', '')
c.PromptManager.in_template = '{color.DarkGray}%s>>> ' % (prompt and prompt + ' ')
