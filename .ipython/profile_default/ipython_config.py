...
# Load my own style, from <profile>/styles, programmtically into pygments
import pkg_resources
dist = pkg_resources.Distribution(location=os.path.join(
  os.path.dirname(os.path.abspath(__file__)),
  'styles',
))
dist._ep_map = {'pygments.styles':
  {
    'ervandew': pkg_resources.EntryPoint.parse(
        'ervandew = ervandew:ErvandewStyle',
        dist=dist,
    )
  }
}
pkg_resources.working_set.add(dist)
c.TerminalInteractiveShell.highlighting_style = 'ervandew'
